  ...
  return (
    <div className="bg-azul-joginere  flex flex-col justify-center items-center w-full h-[300px] sm:h-[500px]">
      <div>
        ...
        <h3 className=" m-4 font-bold text-amber-50 text-center text-lg sm:text-xl md:text-2xl lg:text-xl xl:text-4xl">
          Conoce los productos y servicios que ofrecemos a través de nuestras
          marcas
        </h3>
      </div>
    </div>
